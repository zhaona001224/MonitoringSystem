    ...
    <div class="box-card">
      ...
      <div class="table" v-if="activeIndex == 0">
        <el-table :data="tableData" width="100%">
          ...
          <template slot-scope="scope">
              {{scope.row.key&&pointData[scope.row.key].name}}
            </template>
          </el-table-column>
          <el-table-column
            align="center"
          ...
          >
          <template slot-scope="scope">
              {{scope.row.value}} {{scope.row.key&&pointData[scope.row.key].unit}}
            </template>
          </el-table-column>
        </el-table>
      </div>
      <div class="table" v-if="activeIndex == 1">
        <el-table :data="tableData" width="100%">
          ...
          >
            <template slot-scope="scope">
            	 <span class="fix" @click="fix(scope.row,1)">预防检修 </span>
            </template>
          </el-table-column>
          <el-table-column
            label="故障确认"
      ...
      <el-dialog title="" :visible.sync="showTip1" width="30%">
        <div v-html="activeObj.rel&&pointData[activeObj.rel].instruction"></div>
